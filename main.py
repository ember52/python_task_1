...
string1= str(input("please type your desired string :"))
index = int(input("please input the desired index to be changed:"))
character1=str(input("please type your desired character to be inserted :"))
